...
if(isset($_POST['btnadd'])) 
{
	...
	echo "<script>window.location='attendancepie.php?pieid=$pieid  & sdate=$sdate & edate=$edate & eid=$neweid'</script>";
...
<form action="chooseattpie.php" method="post" enctype="multipart/form-data">
