...
if(isset($_POST['btnadd'])) 
{
	...
	echo "<script>window.location='pie.php?rateid=$rateid  & sd=$sdate & ed=$edate & eid=$neweid'</script>";
...
<form action="chooserate.php" method="post" enctype="multipart/form-data">
