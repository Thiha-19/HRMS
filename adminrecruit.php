...
{
    echo "<script>window.location='recruitment.php'</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<script>
    ...
    <form action="adminrecruit.php" method='post' style = "">
    <fieldset>
...
?>
    ...
    <input type="submit" value="Add Recruitment" class="btn btn-secondary" name="btnadd"> 
<?php
}
?>
</fieldset>
