...
if(isset($_POST['btnadd'])) 
{
	...
	echo "<script>window.alert('SUCCESS :Now loading Attendance Pie Chart')</script>";
	echo "<script>window.location='adminattendance.php?pieid=$pieid  & sdate=$sdate & edate=$edate & eid=$neweid'</script>";
...
<form action="adminchooseattpie.php" method="post" enctype="multipart/form-data">

<fieldset class="text-center">
<legend>Enter Attendance Chart Info :</legend>
